...
if(isset($_POST["id_mat"]) && !empty($_POST["id_mat"])){
    ...
    // Prepare la requette
    $sql = "DELETE FROM materiel WHERE id_mat = ?";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="id_mat" value="<?php echo trim($_GET["id_mat"]); ?>"/>
                            <p>Etes vous sûr de vouloir supprimer ce materiel ?</p>
                            <p>
                                <input type="submit" value="OUI" class="btn btn-danger">
                                <a href="materiel.php" class="btn btn-secondary">NON</a>
                            </p>
                        </div>
                    </form>
                </div>
